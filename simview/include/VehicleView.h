...
public:
     ...
     */
    void update(const SimState::VehicleState& simState);
...
//     */
//    osg::ref_ptr<osg::Geode> drawBumpers(const ConfigReader& config);
//
//    /**
...
//     */
//    osg::ref_ptr<osg::Geode> drawInfo(const ConfigReader& config, const std::string& fontFile);
